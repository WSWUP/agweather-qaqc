...
FEATURES_DICT = {
    ...
    9: {"var_one_name": "RH Average",
        ...
        "units": "%",
        "qc_filename": "rhavg"},
    10: {"var_one_name": "Soil Temperature 1",
         "var_one_color": "cyan",
         "var_two_name": "Soil Temperature 2",
         "var_two_color": "darkcyan",
         "var_three_name": "Soil Temperature 3",
         "var_three_color": "darkblue",
         "units": "°C",
         "qc_filename": "soil_temperature"},
    11: {"var_one_name": "Soil Moisture 1",
         "var_one_color": "cyan",
         "var_two_name": "Soil Moisture 2",
         "var_two_color": "darkcyan",
         "var_three_name": "Soil Moisture 3",
         "var_three_color": "darkblue",
         "units": "%",
         "qc_filename": "soil_moisture"},
    12: {"var_one_name": "Ko Curve",
         "var_one_color": "black",
         "var_two_name": None,
         "var_two_color": None,
         "var_three_name": None,
